...
// CODE HERE
const evenNumbers = mixedNumbers.filter(function(mixedNumbers) {
...
// CODE HERE
const postTaxPrices = prices.map(function(postTaxPrices) {
  return postTaxPrices * 1.07
})
...
// CODE HERE
const totalPopulation = populations.reduce(function(totalPopulation, populations) {
...
const orderTotals = orders.map(function(totals) {
